...
This project demonstrates how to use **Machine Learning algorithms** to predict the likelihood of presence of **heart disease** based on patient medical records, assisting in the early diagnosis.  
